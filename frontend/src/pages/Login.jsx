    ...
    <div style={s.page}>
      ...
      <div style={s.card}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={s.inputWrap}>
            <span style={s.inputIcon}>🔒</span>
            <input style={s.input} type="password" name="password" placeholder="Password"
        ...
        <p style={s.link}>No account? <Link to="/register" style={s.linkA}>Create one free</Link></p>
      </div>
    </div>
  );
}
...
const s = {
  ...
  blob1:    { position: 'fixed', top: '-150px', right: '-150px', width: '500px', height: '500px', borderRadius: '50%', background: 'radial-gradient(circle,rgba(102,126,234,0.25),transparent)', pointerEvents: 'none' },
  blob2:    { position: 'fixed', bottom: '-150px', left: '-150px', width: '500px', height: '500px', borderRadius: '50%', background: 'radial-gradient(circle,rgba(240,147,251,0.25),transparent)', pointerEvents: 'none' },
  blob3:    { position: 'fixed', top: '30%', left: '30%', width: '300px', height: '300px', borderRadius: '50%', background: 'radial-gradient(circle,rgba(67,233,123,0.15),transparent)', pointerEvents: 'none' },
  ...
  logoText: { fontSize: '22px', fontWeight: 900, background: 'linear-gradient(135deg,#667eea,#f5576c)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' },
  ...
  btn:      { width: '100%', padding: '14px', background: 'linear-gradient(135deg,#667eea,#764ba2)', color: '#fff', border: 'none', borderRadius: '14px', fontSize: '15px', fontWeight: 700, cursor: 'pointer', marginTop: '4px', letterSpacing: '0.3px' },
  link:     { textAlign: 'center', fontSize: '13px', color: '#888', marginTop: '1rem' },
  linkA:    { color: '#667eea', fontWeight: 700, textDecoration: 'none' },
};